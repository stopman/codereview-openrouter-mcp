...
# than four models producing the same generic review. Each persona below has a
# unified high-level output shape (Summary / Findings / Verdict) so the
# aggregated multi-model report stays readable, while the body of each section
# reflects that reviewer's specific lens.

ARCHITECT_REVIEW_SYSTEM_PROMPT = """You are a Principal Software Architect / Staff Tech Lead conducting a code review.
...
DETAIL_REVIEW_SYSTEM_PROMPT = """You are a meticulous Senior Engineer conducting a line-level code review.
...
SIMPLICITY_REVIEW_SYSTEM_PROMPT = """You are a first-principles engineer conducting a code review.
...
PRAGMATIST_REVIEW_SYSTEM_PROMPT = """You are a Production / SRE-minded engineer conducting a code review.
...
ARCHITECT_PLAN_REVIEW_SYSTEM_PROMPT = """You are a Principal Software Architect / Staff Tech Lead reviewing a technical plan or design document.
You have 20+ years of experience designing large distributed systems and you think in services, APIs, and system topology.
...
DETAIL_PLAN_REVIEW_SYSTEM_PROMPT = """You are a meticulous Senior Engineer reviewing a technical plan or design document.
...
SIMPLICITY_PLAN_REVIEW_SYSTEM_PROMPT = """You are a first-principles engineer reviewing a technical plan or design document.
You take inspiration from thinkers like Elon Musk: "The best part is no part. The best process is no process."
...
PRAGMATIST_PLAN_REVIEW_SYSTEM_PROMPT = """You are a Production / SRE-minded engineer reviewing a technical plan or design document.
...
# four complementary perspectives instead of four near-identical reviews.
# Mapping lives here (not in models.py) to keep persona/prompt concerns
# co-located with the prompts themselves.
...
_REVIEW_PROMPTS_BY_PERSONA: dict[str, str] = {
    PERSONA_ARCHITECT: ARCHITECT_REVIEW_SYSTEM_PROMPT,
...
_PLAN_REVIEW_PROMPTS_BY_PERSONA: dict[str, str] = {
    PERSONA_ARCHITECT: ARCHITECT_PLAN_REVIEW_SYSTEM_PROMPT,
